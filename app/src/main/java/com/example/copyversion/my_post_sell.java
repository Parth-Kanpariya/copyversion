 ...
 */
public class my_post_sell extends Fragment implements FeedAdapter.ListItemClickListener {
...
//
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                getParentFragmentManager().beginTransaction().detach(my_post_sell.this).commit();
                sellingList.clear();
                getParentFragmentManager().beginTransaction().attach(my_post_sell.this).commit();
...
//                l.setAdapter(new FeedAdapter(donationList,sellingFragment.this::onListItemClick));
                ...
                sl.setAdapter(new FeedAdapterSell(sellingList, my_post_sell.this::onListItemClick, getContext()));
