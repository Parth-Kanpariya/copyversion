...
//        binding = ActivityHomePagerBinding.inflate(getLayoutInflater());
            ...
            sectionsPagerAdapter.add(new my_post_donor(), "Donation");
            sectionsPagerAdapter.add(new my_post_raise(), "Raise");
            sectionsPagerAdapter.add(new my_post_sell(), "Sell");




            viewPager = rootView.findViewById(R.id.view_pager_mypost);
            viewPager.setAdapter(sectionsPagerAdapter);
            TabLayout tabs = rootView.findViewById(R.id.tabss);
