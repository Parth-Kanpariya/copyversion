...
public class SortPlaces implements Comparator<DonorInfo> {

    private double currentLongitude,currentLatitude;

    public SortPlaces(double currentLatitude,double currentLongitude){
    ...
    @Override
    public int compare(DonorInfo o1, DonorInfo o2) {
