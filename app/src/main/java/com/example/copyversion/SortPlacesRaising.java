...
public class SortPlacesRaising implements Comparator<FoodRaiseInfo> {

    private double currentLongitude,currentLatitude;

    public SortPlacesRaising (double currentLatitude,double currentLongitude){
    ...
    @Override
    public int compare(FoodRaiseInfo o1, FoodRaiseInfo o2) {
